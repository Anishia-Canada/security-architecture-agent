...
![Agent Screenshot](docs/screenshots/mapping_output.png)
...
FastAPI Backend (agent_v2.py)
      ...
      │     └── Framework scoring + mapping generation
      │
      ├── ChromaDB (local vector store)
      │     └── 1,450 chunks from 22 framework PDFs
      │     └── Queried via sentence-transformers embeddings
      │
      └── knowledge_base.py (fallback citations)
```
